...
class StyleFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val boldButton = view.findViewById<Button>(R.id.bold)
        val italicButton = view.findViewById<Button>(R.id.italic)
        val resetButton = view.findViewById<Button>(R.id.reset)
        val helloWorldTextView = view.findViewById<TextView>(R.id.text_hello)
